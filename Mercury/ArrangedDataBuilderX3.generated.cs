...
namespace Mercury.Arrange
{
	internal sealed class ArrangedDataBuilder<TSut, TData1, TData2, TData3> : IArrangedWithData<TSut, TData1, TData2, TData3>, IDataSuite<Tuple<TData1, TData2, TData3>>
    {
        ...
        public IAssertCaseBuilder<TPostAct, TData1, TData2, TData3> Act<TPostAct>(Func<TSut, TData1, TData2, TData3, TPostAct> actFunc)
        {
            return new PreAssertBuilder<TPostAct, TData1, TData2, TData3>(
			    this,
                (data1, data2, data3) =>
                {
