...
namespace Mercury
{
    public static class ExtensionsX5 {
        ...
        /// <returns></returns>
        public static IPostAssertCaseBuilder<TActual, TUnusedData1, TUnusedData2, TUnusedData3, TUnusedData4, TExpected> Assert<TActual, TUnusedData1, TUnusedData2, TUnusedData3, TUnusedData4, TExpected>(
            ...
            return builder.Assert((actual, unusedData1, unusedData2, unusedData3, unusedData4, expected) => assertMethod(actual, expected));
        }
